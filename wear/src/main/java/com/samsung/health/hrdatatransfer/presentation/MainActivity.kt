        ...
        setContent {
            ...
            Permission {
                MainScreen(
                    ...
                    trackingState.isPeriodicSending,
                    onStart = { viewModel.startTracking(); Log.i(TAG, "startTracking()") },
                    onStop = { viewModel.stopTracking(); Log.i(TAG, "stopTracking()") },
                    onSend = { viewModel.sendMessage(); Log.i(TAG, "sendMessage()") }
                )
            }
        }
    }
